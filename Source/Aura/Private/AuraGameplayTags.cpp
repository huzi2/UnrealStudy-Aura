...
void UAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Abilities_Fire_FireBolt = UGameplayTagsManager::Get().AddNativeGameplayTag(TEXT("Abilities.Fire.FireBolt"), TEXT("Fire Bolt Ability Tag"));
	GameplayTags.Abilities_Fire_FireBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(TEXT("Abilities.Fire.FireBlast"), TEXT("Fire Blast Ability Tag"));
